...
<div class="container">
  <div class="card mt-5">
    <div class="card-header">
      <h2 style="font-family:  Comic Sans MS, sans-serif;font-style: oblique;  font-weight: bold;color: red;">List Teachers</h2>
      <div class="timkiem">
      ...
      <div class="add-new-teacher">
        <table> 
        <tr>
              <a href="management.php?controller=teacher&action=add_teacher" style="width: 250px; margin-left: 700px; " class="btn btn-danger">Add New teacher</a>
        </tr>
        </table>
      </div>
    </div>
        ...
        foreach($data_Search as $value)
          ...
          <tr>
            ...
            <td>
              ...
              <a onclick="return confirm('Are you sure you want to delete this entry?')" href="management.php?controller=teacher&action=delete_teacher&teacherid=<?php echo $value['teacherid']; ?>" class='btn btn-danger'>Delete</a>
            </td>
          </tr>
        <?php
            $stt++;

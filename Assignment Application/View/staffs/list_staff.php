        ...
        foreach($data as $value)
          ...
          <tr>
            ...
            <td>
              ...
              <a onclick="return confirm('Are you sure you want to delete this Staff?')" href="management.php?controller=staff&action=delete_staff&staffid=<?php echo $value['staffid']; ?>" class='btn btn-danger'>Delete</a>
            </td>
          </tr>
        <?php
            $stt++;
